...
# Author: Bruce-Lee-LY
# Date: 22:37:16 on Tue, May 24, 2022
#
...
echo "branch: $BRANCH" >> $WORK_PATH/output/ds_version
echo "commit: $COMMIT" >> $WORK_PATH/output/ds_version
echo "gcc_version: $GCC_VERSION" >> $WORK_PATH/output/ds_version
echo "compile_time: $COMPILE_TIME" >> $WORK_PATH/output/ds_version
